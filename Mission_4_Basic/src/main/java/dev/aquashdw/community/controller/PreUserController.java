...
@RestController
@RequestMapping("pre-user-controller")
public class PreUserController {
    private static final Logger logger = LoggerFactory.getLogger(PreUserController.class);
    private final UserService userService;

    public PreUserController(UserService userService) {
